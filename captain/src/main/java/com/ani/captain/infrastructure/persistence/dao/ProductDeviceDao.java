...
public class ProductDeviceDao implements Serializable {
    @Id
    ...
    public ProductDeviceDao() {
    }

    public ProductDeviceDao(Long productId, String name, String description, String type, Integer version, Long installed, Integer stars, Integer totalComments, Long lastModTime, ProductState state, String logo, Byte[] token) {
