    ...
    return (
      <div className="debug-panel-wrapper">
        <div className="debug-panel container-fluid">
          <div className="row">
            <div className="input col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-22">
            ...
            <div className="output col-lg-6 col-md-6 col-sm-6 col-xs-22">
...
export default connect()(DebugPanel)