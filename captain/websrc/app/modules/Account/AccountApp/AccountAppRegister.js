...
import {updateAccountApp} from '../actions';

class AccountAppRegister extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className="account-register">
        <div className="title">应用开发者申请</div>
        <div className="description">欢迎加入Anicloud成为应用开发者，轻松实现和分享您的创意，让更多人受益！</div>
        <div className="form">
...
AccountAppRegister.propTypes = {
};

AccountAppRegister.defaultProps = {
};
