...
import {updateAccountDevice, destroyAccountDevice} from '../actions';

class AccountDeviceSettings extends Component {
  constructor(props) {
    super(props);
  ...
  redirectToRegister(props) {
    if (!props.account.entity.vendor) {
      props.push('/account/device/register');
    }
  }

  onDestroy() {
    this.props.destroyAccountDevice();
  }
...
AccountDeviceSettings.propTypes = {};

AccountDeviceSettings.defaultProps = {};

export default connect(mapStateToProps, {
  push,
  updateAccountDevice,
  destroyAccountDevice
