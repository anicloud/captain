...
class AppAccountManager extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
...
AppAccountManager.propTypes = {};

AppAccountManager.defaultProps = {};

export default connect(mapStateToProps)(AppAccountManager)