...
class AppAccountRegister extends Component {
  constructor(props) {
    super(props);
    this.state = {
    };
...
AppAccountRegister.propTypes = {
};

AppAccountRegister.defaultProps = {
};

export default connect(mapStateToProps)(AppAccountRegister)